...
\chapter{Besluit}
Resampling is een slechte manier om geluid te versnellen en vertragen omdat het zorgt voor een verschuiving in toonhoogte. Een betere manier is om gebruik te maken van OLA. Deze splitst het signaal op in overlappende delen en combineert deze met een vaste overlap. Een crossfade functie kan toegevoegd worden om het algoritme te verbeteren. SOLA gaat na welke overlapping de maximale overeenkomsten vertoont en zal zo overlappen. PSOLA maakt gebruik van pith detection om ?????????NOG VERDER AANVULLEN. Een vervolg bestaat erin het beste algoritme, PSOLA, te implementeren in Simulink om zo in real time geluid te kunnen vertragen. 
%besluit nog verder aanvullen
