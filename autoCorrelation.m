...
MIN_THRESHOLD = 0.3;%How much smaller than the maximum correlation value a point has to be before we assume a peak has been passed.
MAX_THRESHOLD = 0.7;%How much larger that the previous maximum correlation value a point has to be before we assume that the correlation signas is rising again.
